class Clawk < Formula
  ...
  version "0.0.0" # auto-updated by clawk's release workflow on each tag
  license "Apache-2.0"
  ...
  url "https://github.com/clawkwork/clawk/releases/download/v0.0.0/clawk-v0.0.0-darwin-arm64.tar.gz"
